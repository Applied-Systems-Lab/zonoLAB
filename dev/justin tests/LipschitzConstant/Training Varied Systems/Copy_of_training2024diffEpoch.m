...
A = [2 5];              % 2 in 1 out
% A = [1 3; 4 2];       % 2 in 2 out
% A = [1 9; 8 2;5 5];   % 2 in 3 out
...
h_layers = [10 7 5];     % Defining layers for NN
...
if(fromScratch)
    ...
    options = trainingOptions("sgdm",'Momentum', momentum, MaxEpochs = epochs,Plots='training-progress');
