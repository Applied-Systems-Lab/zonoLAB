...
%%
load('200dpClass.mat')
% load('2000dp10000epClassification.mat')
% 
...
NNc1 = NN([NN.dimKeys(1:2) NN.dimKeys(4)]);
...
%%
plot(NNc1.Z(NNc1.dimKeys),'k',0.2)
...
Gc1 = [  0.15 0;
    ...
    intersectedClass2 = NNc1.Z(NNc1.dimKeys).and(domainClass2,[1 0 0; 0 1 0]);
    ...
    intersectedClass1 = NNc1.Z(NNc1.dimKeys).and(domainClass1,[1 0 0; 0 1 0]);
